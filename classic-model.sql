...
CREATE TABLE customer (
  ...
  CONSTRAINT customers_ibfk_1 FOREIGN KEY (salesRepEmployeeNumber) REFERENCES employee (employeeNumber)
) ;
...
(496,'Kelly''s Gift Shop','Snowden','Tony','+64 9 5555500','Arenales 1938 3''A''',NULL,'Auckland  ',NULL,NULL,'New Zealand',1612,11000.00);
...
('S72_3212','Pont Yacht','Ships','1:72','Unimax Art Galleries','Measures 38 inches Long x 33 3/4 inches High. Includes a stand.\r\nMany extras including rigging, long boats, pilot house, anchors, etc. Comes with 2 masts, all square-rigged',414,3.30,.60);
...
CREATE TABLE orders (
  ...
  CONSTRAINT orders_ibfk_1 FOREIGN KEY (customerNumber) REFERENCES customer (customerNumber)
) ;
...
(10332,'S18_1342',46,8.38,5);

insert  into orderdetail (orderNumber,productCode,quantityOrdered,priceEach,orderLineNumber) values (10332,'S18_1367',27,51.21,16),
...
(10406,'S18_1984',48,13.72,) ;

insert  into orderdetail (orderNumber,productCode,quantityOrdered,priceEach,orderLineNumber) values (10406,'S18_3685',65,117.26,1),
